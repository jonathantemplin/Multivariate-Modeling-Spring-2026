...
Search for `r.plot.view` and set it to:
`httpgd`
...
**The "Elevator Pitch":**
* If RStudio and VS Code had a child, it would be Positron.
* It offers the **Data Explorer** and **Variable View** you love in RStudio.
* It offers the **Editor speed**, **Copilot integration**, and **Customizability** of VS Code.
